...
namespace damminhnhat
{
    public partial class ql_users : Form
    {
        ...
        void load()
        {
            string sql = "SELECT tk As N'Tài khoản', mk AS N'Mật khẩu' FROM tkuser";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                string sql1 = "insert into tkuser values ('" + txb_username.Text + "', '" + getMD5(txb_pass.Text) + "') ";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                string sql1 = "update tkuser set mk='" + getMD5(txb_pass.Text) + "' where tk='" + txb_username.Text + "'";
                KetNoiCSDL.themsuaxoa(sql1);
