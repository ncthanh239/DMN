...
namespace damminhnhat
{
    public partial class ql_giaovien : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                string sql1 = "update tkgv set mk='" + txb_pass.Text + "' where tk='" + txb_username.Text + "'";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                string sql1 = "insert into tkgv values ('" + txb_username.Text + "', '" + txb_pass.Text + "') ";
                KetNoiCSDL.themsuaxoa(sql1);
